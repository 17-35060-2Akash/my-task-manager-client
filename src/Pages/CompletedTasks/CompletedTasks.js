        ...
        <div className="max-w-lg bg-white md:border md:border-gray-200 rounded-lg md:shadow-md dark:bg-gray-800 dark:border-gray-700 mx-auto my-32">
            ...
            <div className="p-5 pt-0 pb-7">
                ...
                <div className='flex flex-col md:flex-row align-middle justify-center'>
                    ...
                    <button onClick={() => setCommentToggler(!commentToggler)} type="button" className="text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-sm px-9 py-2.5 text-center mb-2">{commentToggler ? "Hide Comment" : "Post Comment"}</button>
                </div>
